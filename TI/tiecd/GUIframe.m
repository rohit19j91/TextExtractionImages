...
%% Point detection
Y = imread('C:\Users\user\Documents\bapu work\TI\tiecd\gray111.jpg');
Y1= bwareaopen(Y, 20);
...
%Edge Detection
i = imread('C:\Users\user\Documents\bapu work\TI\tiecd\gray111.jpg');
figure;
I = rgb2gray(i);
BW10= edge(I,'canny');
subplot (2,2,1);
...
%Segmentation
clc;
J = imread ('C:\Users\user\Documents\bapu work\TI\tiecd\gray111.jpg ');
figure;
I = rgb2gray (J);
...
im=imread('C:\Users\user\Documents\bapu work\TI\tiecd\gray111.jpg');
im1=rgb2gray(im);
